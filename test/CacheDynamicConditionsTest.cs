    ...
    public class CacheDynamicConditionsTest
    {
        ...
        public void TestConditionalCache()
        {
            ...
            collection.AddScopedCached<IUserService, UserService>(s => s.
                SetFor(m => m.GetUser(0), "user-{id}").SetCacheConditionFunction(user => user.Name == "User1").Configure()
            );
        ...
        public void TestConditionalTimeout()
        {
            ...
            collection.AddMemoryCache();
            collection.AddScopedCached<IUserService, UserService>(s => s.
                SetFor(m => m.GetUser(0), "user-{id}").SetTimeoutOffsetFunction(u => u.TimeouMs).Configure().
